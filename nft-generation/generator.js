...
const build = async(index, onComplete) => {
  const _path = '/home/janus/work/node.js_tutorial/nft-generation';
  var _traits = [];

  const background = Traits.getBackground();
  const backgroundJimp = await Jimp.read(_path +
    '/Traits/Background/Background_' +
    background +
    '.png');
  _traits.push({
  ...
  const bodyJimp = await Jimp.read(_path +
    '/Traits/Body/Body_' +
    bodyAndHead +
    '.png');  
  _traits.push({
  ...
  const outfitJimp = await Jimp.read(_path +
    '/Traits/Outfit/Outfit_' +
    outfit +
    '.png');
  _traits.push({
    'trait_type': 'Outfit',
  ...
  const headJimp = await Jimp.read(_path +
    '/Traits/Head/Head_' +
    bodyAndHead +
    '.png');
  _traits.push({
  ...
  const noseJimp = await Jimp.read(_path +
    '/Traits/Nose/Nose_' +
    nose +
    '.png');
  _traits.push({
  ...
  const mouthJimp = await Jimp.read(_path +
    '/Traits/Mouth/Mouth_' +
    mouth +
    '.png');
  _traits.push({
  ...
  const eyesJimp = await Jimp.read(_path +
    '/Traits/Eyes/Eyes_' +
    eyes +
    '.png');
  _traits.push({
  ...
  const sunglassesJimp = await Jimp.read(_path +
    '/Traits/Sunglasses/Sunglasses_' +
    sunglasses +
    '.png');
  _traits.push({
  ...
  const headwearJimp = await Jimp.read(_path +
    '/Traits/Headwear/Headwear_' +
    headwear +
    '.png');
  _traits.push({
    'trait_type': 'Headwear',
